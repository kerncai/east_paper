...
WSGI_APPLICATION = 'east_paper.wsgi.application'
...
MEDIA_ROOT = os.path.join(BASE_DIR, '.')     #设置静态文件路径为主目录下上传图片的目录
MEDIA_URL = '/face/'                                               #上传图片访问的url
...
# 配置ASGI
ASGI_APPLICATION = "east_paper.routing.application"
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '[east_paper] %(levelname)s %(asctime)s %(module)s %(message)s'
        }
    },
    'handlers': {
        'console': {
